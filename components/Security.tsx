...
// 3. Certification badges (SOC 2, GDPR, HIPAA, ISO 27001, CCPA) stay in English
...
const featureIcons = [
  // SOC 2 shield icon
  <svg key="soc2" className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              {featureKeys.map((featureKey, index) => (
                ...
                >
                  ...
                  <div>
                    {/* t('feature1.title') → "SOC 2 Type II" (same in both) or "Conforme al GDPR" */}
